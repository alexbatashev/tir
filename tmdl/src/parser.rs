    ...
    recursive(|expr| {
        fn builtin_from_ident(name: &str) -> Option<BuiltinFunction> {
            match name {
                ...
                "store_conditional" => Some(BuiltinFunction::StoreConditional),
                "atomic_rmw" => Some(BuiltinFunction::AtomicRmw),
                "fence" => Some(BuiltinFunction::Fence),
                "fence_i" => Some(BuiltinFunction::FenceI),
