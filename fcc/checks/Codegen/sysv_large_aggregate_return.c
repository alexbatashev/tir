...
// pointer parameter and returns that pointer on a state that joins the copy's
// chain; the forwarding caller passes a temporary, copies it into its own
// result address after the call, and returns the address the same way.
